...
Front End Libraries Projects #1 on freecodecamp.org
...
Description: styling was done with styled-components

Additionally to user story:
- Random color for every quote
- Smooth transition between colors
- Fade out/ fade in text
- You can change animation speed in App state (animationTime)
